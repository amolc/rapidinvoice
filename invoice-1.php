...
class invoicr extends FPDF_rotation 
{
	...
	var $margins = array('l'=>20,'t'=>20,'r'=>20,'b' => 20);
	...
	*******************************************************************************/
	...
	function setqrcode($paynowlogo=0,$maxWidth=0,$maxHeight=0)
	{
		$this->paynowlogo = $paynowlogo;
		$this->paynowdimensions = $this->resizeToFit($paynowlogo);
	...
	{	
		...
		foreach($this->addText as $text) 
		{
			...
			if($text[0] == 'paragraph') 
			{
				...
				// if(isset($this->paynowlogo)) {
				// 	$this->Image($this->paynowlogo,$this->margins['l'],$this->margins['t'] + 300,$this->paynowdimensions[0],$this->paynowdimensions[1]);
				// }
				$this->Ln(4);
			}
		}
