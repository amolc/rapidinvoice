...
if ($action == 'create_invoice'){
	...
	if($mysqli -> multi_query($query)){
		...
		//Set to
		$invoice->setTo(array($customer_name,$customer_address_1,$customer_address_2,$customer_town,$customer_county,$customer_postcode));
		//Ship to
		...
		$invoice->addParagraph("line 419");
		// $invoice->setqrcode(PAYNOW_LOGO,PAYNOW_LOGO_WIDTH,PAYNOW_LOGO_HEIGHT);
		// $this->Image($this->logo,$this->margins['r'],$this->margins['t'] ,$this->dimensions[0],$this->dimensions[1]);
		//Set footer note
